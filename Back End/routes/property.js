...
router.post('/property_upload',properties.upload.fields([{name: "images", maxCount: 5},{name: "file", maxCount: 1}]),properties.propertyUpload); //property data upload to unapproved properties collection
